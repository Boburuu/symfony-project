    ...
    ClassicEditor
        .create(editorInput, {
            ...
            toolbar: {
                ...
                // Ne va pas à la ligne si plus d'itemps mais affiche des ...
        ...
        // Promesse : Dès que la fonction ci-dessus est exécutée, faire ce qui suit en cas d'erreur (récupère ce que la fonction a fait):
        .then(editor=>{
            // Rattache l'éditeur à la fenêtre pour éviter les pbs de compatibilité des navigateurs
            window.editor=editor;

            // Si form soumis tel que, ne sera pas envoyé en BDD car ce n'est pas l'imput content.
            // Tout le contenu de la div sera injecté directement dans l'input content
            form.addEventListener('submit', (element)=>{
                // "prevent default" casse l'utilisation native d'un élément
